...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "add_new_card": MessageLookupByLibrary.simpleMessage(
    ...
    "card_pay": MessageLookupByLibrary.simpleMessage(
      "Оплата банковской картой",
    ),
    "cards_will_be_stored_here": MessageLookupByLibrary.simpleMessage(
      "Ваши карты будут храниться здесь",
    ),
    "cart_update": MessageLookupByLibrary.simpleMessage("Обновление корзины"),
    "carts": MessageLookupByLibrary.simpleMessage("Карты"),
    "cashToCourier": MessageLookupByLibrary.simpleMessage("Наличными/Kaspi QR"),
    ...
    "check_status": MessageLookupByLibrary.simpleMessage("Проверить статус"),
    ...
    "deliveryPrice": MessageLookupByLibrary.simpleMessage("Стоимость доставки"),
    ...
    "editAddress": MessageLookupByLibrary.simpleMessage("Редактировать адрес"),
    ...
    "enterName": MessageLookupByLibrary.simpleMessage("Введите имя и фамилию"),
    ...
    "goToPay": m1,
    "goToProducts": MessageLookupByLibrary.simpleMessage("Перейти к покупкам"),
    ...
    "orderEmpty": MessageLookupByLibrary.simpleMessage("Список заказов пуст"),
    ...
    "privacyPol": MessageLookupByLibrary.simpleMessage(
      "Политика конфиденциальности",
    ),
    "privacyPolicy": MessageLookupByLibrary.simpleMessage(
      "Политикой конфиденциальности",
    ),
    "processCancel": MessageLookupByLibrary.simpleMessage("В процессе отмены"),
    ...
    "public_offer": MessageLookupByLibrary.simpleMessage("Публичная оферта"),
    ...
    "update_button": MessageLookupByLibrary.simpleMessage(
      "Обновить приложение",
    ),
