...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "deliveryBefore":
            MessageLookupByLibrary.simpleMessage("Жеткізу уақытына дейін"),
        "deliveryDate":
            MessageLookupByLibrary.simpleMessage("Жеткізу күні мен уақыты"),
        ...
        "getSmsTime":
            MessageLookupByLibrary.simpleMessage("Жаңа кодты алуға болады "),
        ...
        "orderAgain":
            MessageLookupByLibrary.simpleMessage("Тапсырысты қайталау"),
        ...
        "orderEmpty":
            MessageLookupByLibrary.simpleMessage("Тапсырыстар тізімі бос"),
        "orderHistory":
        ...
        "privacyPolicy":
            MessageLookupByLibrary.simpleMessage("Құпиялылық саясаты"),
        "processCancel":
            MessageLookupByLibrary.simpleMessage("Болдырмау процесінде"),
